...
This is not a generic assistant system.
...
The original upstream repository will NOT work correctly with this setup.
...
A baseline semantic search runs automatically.

Model A may request a refined search.

Model A may filter retrieved bullets.
...
Shine decides her tone and personality responses herself —
but grounded in persistent memory.
...
Memory Guarantees
Memory Is Always Checked

Baseline search runs on every message.

Filter Is Safe

If Model A filtering returns empty, original retrieved bullets are preserved.

No Identity Drift from Empty Context

Memory retrieval failures do not silently remove grounding.

Duplicate Prevention

Memory writing avoids:

Re-saving known preferences
